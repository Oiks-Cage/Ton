...
abstract contract listInitializationDebot is Debot, Upgradable {
    ...
    function creditAccount(address value) public {
        ...
        TvmCell empty;
        purchase(m_msigAddress).sendTransaction{
            abiVer: 2,
            extMsg: true,
            sign: true,
            pubkey: pubkey,
    ...
    ) 
    {
        ...
        key = "ShopDebot";
        author = "Oiks";
        hello = "Hi, I am a Shopping DeBot.";
        language = "en";
        dabi = m_debotAbi.get();
        icon = m_icon;
    }
